...
MonoObject *
xamarin_get_nsobject_with_type (id obj, void * type, int32_t * created, guint32 *exception_gchandle);

void
xamarin_dispose (MonoObject * mobj, guint32 *exception_gchandle);

guint32
xamarin_create_product_exception_for_error (int code, guint32 inner_exception_gchandle, const char * message, guint32 *exception_gchandle);
